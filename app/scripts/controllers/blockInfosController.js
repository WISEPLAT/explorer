    ...
    .controller('blockInfosCtrl', function ($rootScope, $scope, $location, $routeParams,$q) {
        ...
        $scope.init=function()
        {
            ...
            if($scope.blockId!==undefined) {
                ...
                getBlockInfos()
                    .then(function(result){
                        var number = web3.wsh.blockNumber;
                    ...
                    //	console.log(web3.wsh.getUncle(uncle1));
                    //}
                    ...
                    if ($scope.blockNumber !== undefined){
                        ...
                        if ($scope.blockNumber !== undefined){
                            var info = web3.wsh.getBlock($scope.blockNumber);
                            if (info !== undefined){
            ...
            function getBlockInfos(){
                ...
                web3.wsh.getBlock($scope.blockId,function(error, result) {
                    if(!error){
        ...
        web3.wsh.getBlockTransactionCount($scope.blockId, function(error, result){
            var txCount = result;
            $scope.numberOfTransactions = txCount;
            for (var blockIdx = 0; blockIdx < txCount; blockIdx++) {
                web3.wsh.getTransactionFromBlock($scope.blockId, blockIdx, function(error, result) {
	                // console.log("Result: ", result);
                    web3.wsh.getTransactionReceipt(result.hash, function(error, receipt) {
                        var transaction = {
                            ...
                            value: web3.fromWei(result.value, "wise"),
