        ...
        $scope.init=function()
        {
            ...
            if($scope.txId!==undefined) { // add a test to check if it match tx paterns to avoid useless API call, clients are not obliged to come from the search form...
                ...
                getTransactionInfos()
                    ...
                    $scope.gasPrice = web3.fromWei(result.gasPrice, "wise").toFormat(10) + " WSH";
                    ...
                    $scope.wshValue = result.value.c[0] / 10000;
                    $scope.txprice = web3.fromWei(result.gas * result.gasPrice, "wise") + " WSH";
            ...
            function getTransactionInfos(){
                ...
                web3.wsh.getTransaction($scope.txId,function(error, result) {
                    if(!error){
